...
class ScpPluginSettings(QtCore.QObject):
    def __init__(self):
        QtCore.QObject.__init__(self)
        self._config_path = '/home/user/.config/FotoShareN9/fotoshare_scp_plugin.cfg'
        self._server = ''
        self._port = ''
        self._path = ''
        self._username = ''
    ...
    def save_settings(self, server, port, path, username, password):
        ...
        if os.path.isfile(self._config_path):
            print "Found scp config file - saving new settings!"
            f = open(self._config_path)
            l = pickle.load(f)
            ...
            pickle.dump(l,f)
            print "Saved successful scp config!"

        else:
            print "Did not found scp config file, creating new one!"
            f = open(self._config_path, 'w')
            pickle.dump(
                        {
                         'server': server,
    ...
    def delete_settings(self):
        ...
        os.remove('/home/user/.config/FotoShareN9/fotoshare_scp_plugin.cfg')
